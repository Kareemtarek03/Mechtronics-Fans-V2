        ...
        >
            ...
            >
                <Box display="flex" alignItems="center" gap={3}>
                    ...
                    <Text color="#ffffff" fontWeight="600" fontSize="lg">
                        {data.name}
                    </Text>
                </Box>
                <Box display="flex" alignItems="center" gap={2}>
                    <Box color="#64748b" p={1}>
                    ...
                    >
                        ...
                        <Box>
                            ...
                            <Box display="flex" gap={2}>
                                ...
                                >
                                    {data.units.map((unit) => (
                                        <option key={unit} value={unit} style={{ background: "#1e293b" }}>
                                            {unit}
                                        </option>
                                    ))}
                                </select>
    ...
    return (
        ...
        >
            <Box maxW="900px" w="100%" mx="auto">
                ...
                <Text color="#94a3b8" fontSize="md" mb={8}>
