      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: '3rem' }}>
          {navItems.map((item) => {
            ...
            const isDisabled = item.path === '/results' && location.pathname === '/fan-selection';
            return (
              <Link
                key={item.path}
                to={item.path}
                style={{ textDecoration: "none", pointerEvents: isDisabled ? 'none' : 'auto', opacity: isDisabled ? 0.5 : 1 }}
              >
                <div style={{ position: 'relative', cursor: 'pointer', padding: '0.25rem 0' }}>
                  <span
        ...
        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative' }} ref={dropdownRef}>
            <button
              onClick={() => {
                console.log('🖱️ User icon clicked! Current state:', showDropdown);
            ...
            {showDropdown && (
              <div style={{
                ...
                <div style={{ padding: '1.25rem', borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>
                  {userData ? (
                    <>
                      <div style={{ color: '#ffffff', fontWeight: '600', fontSize: '1.125rem', marginBottom: '0.5rem' }}>
